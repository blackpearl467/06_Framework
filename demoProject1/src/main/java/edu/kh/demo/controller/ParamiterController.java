...
public class ParamiterController {
	 ...
	 * 
	 * defaultValue: 파라미터 중 일치하는 name 속성값이 없을경우에 대입할 값 지정
	...
	public String paramTest3(
		...
		//{color=Red, fruit=Apple, productName=시골장터, expirationDate=2024-10-30}
	...
	//	같이 사용되는 DTO의 필드면과 같다면
	//자동으로 setter를 호출해서 필드에 값을 세팅
	
	//** 주의사항 **
	//-DTO에 기본생성자가 필수로 존재해야한다!
