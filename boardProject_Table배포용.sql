...
DELETE FROM "MEMBER"
WHERE MEMBER_NICKNAME='쿠로미'; --회원삭제

-- 회원 1번 유저일 암호화된 비밀번호로 업데이트(pass01!)
UPDATE "MEMBER" SET MEMBER_PW = '$2a$10$TxNB54mVg6ajt6tUHDx/5On58SsnolxYebL4do7sa8sopAedotIoi'
WHERE MEMBER_NO = 1;
...
UPDATE "MEMBER" SET 
MEMBER_DEL_FL = 'N'
WHERE MEMBER_NO = 5; --회원탈퇴변경

DELETE FROM "MEMBER"
WHERE MEMBER_NO = 6; --회원삭제

UPDATE "MEMBER" SET
MEMBER_PW = '$2a$10$TxNB54mVg6ajt6tUHDx/5On58SsnolxYebL4do7sa8sopAedotIoi'
WHERE MEMBER_NO =6;

UPDATE "MEMBER" SET
MEMBER_TEL = '01077777777'
WHERE MEMBER_NO = 1; --회원번호변경

UPDATE "MEMBER" SET
MEMBER_NICKNAME = '마이멜로디'
WHERE MEMBER_NO = 2;

DELETE FROM "UPLOAD_FILE"
WHERE FILE_NO = 2; --2번 업로드된 한교동 삭제
...
WHERE "UPLOAD_FILE".MEMBER_NO = 1 --정확히 지명해주기
...
ORDER BY BOARD_NO DESC; --거꾸로나오도록
...
INSERT INTO "BOARD_IMG" VALUES(
	SEQ_IMG_NO.NEXTVAL, '/images/board/', '원본1.jpg', 'test1.jpg', 0, 3996
);

INSERT INTO "BOARD_IMG" VALUES(
	SEQ_IMG_NO.NEXTVAL, '/images/board/', '원본2.jpg', 'test2.jpg', 1, 3996
);

INSERT INTO "BOARD_IMG" VALUES(
	SEQ_IMG_NO.NEXTVAL, '/images/board/', '원본3.jpg', 'test3.jpg', 2, 3996
);

INSERT INTO "BOARD_IMG" VALUES(
	SEQ_IMG_NO.NEXTVAL, '/images/board/', '원본4.jpg', 'test4.jpg', 3, 3996
);

INSERT INTO "BOARD_IMG" VALUES(
	SEQ_IMG_NO.NEXTVAL, '/images/board/', '원본5.jpg', 'test5.jpg', 4, 3996
);
...
( SELECT COUNT(*)
FROM "BOARD_LIKE"
WHERE BOARD_NO=3996 ) LIKE_COUNT,
...
VALUES( SEQ_COMMENT_NO.NEXTVAL, '부모 1의 자식 1',
			  DEFAULT, DEFAULT,	3996, 2, 6010);
			 
INSERT INTO "COMMENT"	
VALUES( SEQ_COMMENT_NO.NEXTVAL, '부모 1의 자식 2',
			  DEFAULT, DEFAULT,	3996, 2, 6011);
...
UPDATE "MEMBER" SET MEMBER_PW = '$2a$10$gpQCyHHoButsvKoywydvfeGpLhQ3MHU7Z3wvIKvnHuKHSCDxHccWS'
WHERE MEMBER_NO = 1;
